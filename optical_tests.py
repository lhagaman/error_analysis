...
run_rat(name="nothing shifted", num_photons=num_photons, wavelength=wavelength, theta_i=theta_i, substance="my_xe",
...
run_rat(name="cell shifted", num_photons=num_photons, wavelength=wavelength, theta_i=theta_i, substance="my_xe",
        tube_included=True, angular_size=angular_size, laser_offset=laser_offset, sample_x=sample_x, sample_y=sample_y,
        cell_x=cell_x, cell_y=cell_y, show=False, run=run, x_min=x_min, x_max=x_max, y_min=y_min, y_max=y_max)
...
run_rat(name="sample shifted", num_photons=num_photons, wavelength=wavelength, theta_i=theta_i, substance="my_xe",
        tube_included=True, angular_size=angular_size, laser_offset=laser_offset, sample_x=sample_x, sample_y=sample_y,
        cell_x=cell_x, cell_y=cell_y, show=False, run=run, x_min=x_min, x_max=x_max, y_min=y_min, y_max=y_max)
...
run_rat(name="laser shifted", num_photons=num_photons, wavelength=wavelength, theta_i=theta_i, substance="my_xe",
        tube_included=True, angular_size=angular_size, laser_offset=laser_offset, sample_x=sample_x, sample_y=sample_y,
        cell_x=cell_x, cell_y=cell_y, show=False, run=run, x_min=x_min, x_max=x_max, y_min=y_min, y_max=y_max)
